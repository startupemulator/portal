export const state = () => ({
    ...
    startupCard: [{
        ...
        },
        {
            ...
            started: true,
            text: "There is a description of this projects, where a product owner should describe his ide...",
    ...
    challenges: [{
            ...
            text: "The part of description that appears only in three lines maximum. Other part is hidde...",
    ...
    practicant: [{
            id: 0,
            fullName: "Full Name",
            text: "Some comment and feedback from an expert that belongs to some exact action in this list. Some comment and feedback from an expert that belongs to some exact action in this list.",
        ...
        },
        {
            id: 1,
            fullName: "Full Name",
            text: "Some comment and feedback from an expert that belongs to some exact action in this list. ",
            position: "Front-end Developer",
...
export const mutations = {
    changeStepOnApplyToTeam(state) {
        state.applyToTeam.stepOne = !state.applyToTeam.stepOne;
    },
    applyStartUp(state) {
        state.applyToTeam.applied = !state.applyToTeam.applied;
    },
    addTechnology(state, name) {
        state.technology.push({ id: state.technology.length + 1, name });
    },
    removeTechnology(state, id) {
        // console.log(id);
        state.technology.splice(id, 1);
    },
    identifyDevice(state, device) {
        state.device = device;
    },
